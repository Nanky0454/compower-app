...
import { Eye, Download, Loader2, Ban, Undo2 } from 'lucide-vue-next'
...
<template>
  <div class="space-y-4">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-3xl font-bold">Guías de Remisión</h1>
      <Button as-child>
              ...
              <TableCell class="text-right">
                <div class="flex justify-end gap-2">
                  ...
                  <Button as-child variant="ghost" size="icon" class="h-8 w-8" title="Ver Detalle">
                   ...
                   <Button as-child variant="secondary" size="icon" class="h-8 w-8" title="Devolver"
                           v-if="transfer.gre_series && transfer.status !== 'Anulada'">
                      <RouterLink :to="`/inventory/transfers/${transfer.id}/return`">
                          <Undo2 class="h-4 w-4" />
                      </RouterLink>
                  </Button>
                  <Button
